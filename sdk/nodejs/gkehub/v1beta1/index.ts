...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:gkehub/v1beta1:Membership":
                return new Membership(name, <any>undefined, { urn })
            case "google-hybrid:gkehub/v1beta1:MembershipIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "gkehub/v1beta1", _module)
