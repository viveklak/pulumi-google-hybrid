...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:gkehub/v1alpha:Feature":
                return new Feature(name, <any>undefined, { urn })
            case "google-hybrid:gkehub/v1alpha:FeatureIamPolicy":
                return new FeatureIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:gkehub/v1alpha:Fleet":
                return new Fleet(name, <any>undefined, { urn })
            case "google-hybrid:gkehub/v1alpha:Membership":
                return new Membership(name, <any>undefined, { urn })
            case "google-hybrid:gkehub/v1alpha:MembershipIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "gkehub/v1alpha", _module)
