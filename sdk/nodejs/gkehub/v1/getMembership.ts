...
export function getMembership(args: GetMembershipArgs, opts?: pulumi.InvokeOptions): Promise<GetMembershipResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:gkehub/v1:getMembership", {
...
export interface GetMembershipResult {
     ...
     */
    readonly authority: outputs.gkehub.v1.AuthorityResponse;
    /**
     ...
     */
    readonly endpoint: outputs.gkehub.v1.MembershipEndpointResponse;
    /**
     ...
     */
    readonly state: outputs.gkehub.v1.MembershipStateResponse;
    /**
