...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:contactcenterinsights/v1:Analysis":
                return new Analysis(name, <any>undefined, { urn })
            case "google-hybrid:contactcenterinsights/v1:Conversation":
                return new Conversation(name, <any>undefined, { urn })
            case "google-hybrid:contactcenterinsights/v1:IssueModel":
                return new IssueModel(name, <any>undefined, { urn })
            case "google-hybrid:contactcenterinsights/v1:PhraseMatcher":
                return new PhraseMatcher(name, <any>undefined, { urn })
            case "google-hybrid:contactcenterinsights/v1:View":
...
pulumi.runtime.registerResourceModule("google-hybrid", "contactcenterinsights/v1", _module)
