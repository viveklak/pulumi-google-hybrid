...
/** @deprecated google-hybrid.monitoring.getSecretVersion has been deprecated in favor of google-hybrid.secretmanager.getSecretVersion */
export function getSecretVersion(args: GetSecretVersionArgs, opts?: pulumi.InvokeOptions): Promise<GetSecretVersionResult> {
    pulumi.log.warn("getSecretVersion is deprecated: google-hybrid.monitoring.getSecretVersion has been deprecated in favor of google-hybrid.secretmanager.getSecretVersion")
    if (!opts) {
        opts = {}
    }

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts);
    return pulumi.runtime.invoke("google-hybrid:monitoring/classic:getSecretVersion", {
