...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:domains/v1alpha2:Registration":
                return new Registration(name, <any>undefined, { urn })
            case "google-hybrid:domains/v1alpha2:RegistrationIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "domains/v1alpha2", _module)
