...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:domains/v1:Registration":
                return new Registration(name, <any>undefined, { urn })
            case "google-hybrid:domains/v1:RegistrationIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "domains/v1", _module)
