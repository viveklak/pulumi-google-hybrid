...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:containeranalysis/v1:Note":
                return new Note(name, <any>undefined, { urn })
            case "google-hybrid:containeranalysis/v1:NoteIamPolicy":
                return new NoteIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:containeranalysis/v1:Occurrence":
                return new Occurrence(name, <any>undefined, { urn })
            case "google-hybrid:containeranalysis/v1:OccurrenceIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "containeranalysis/v1", _module)
