...
export class VpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:compute/beta:VpnGateway';
...
export interface VpnGatewayArgs {
     ...
     * The stack type for this VPN gateway to identify the IP protocols that are enabled. If not specified, IPV4_ONLY will be used.
     */
    stackType?: pulumi.Input<enums.compute.beta.VpnGatewayStackType>;
    /**
     * The list of VPN interfaces associated with this VPN gateway.
     */
    vpnInterfaces?: pulumi.Input<pulumi.Input<inputs.compute.beta.VpnGatewayVpnGatewayInterfaceArgs>[]>;
}
