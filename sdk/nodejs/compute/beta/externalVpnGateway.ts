...
export class ExternalVpnGateway extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:compute/beta:ExternalVpnGateway';
...
export interface ExternalVpnGatewayArgs {
     ...
     * A list of interfaces for this external VPN gateway. If your peer-side gateway is an on-premises gateway and non-AWS cloud providers' gateway, at most two interfaces can be provided for an external VPN gateway. If your peer side is an AWS virtual private gateway, four interfaces should be provided for an external VPN gateway.
     */
    interfaces?: pulumi.Input<pulumi.Input<inputs.compute.beta.ExternalVpnGatewayInterfaceArgs>[]>;
    /**
     * Labels for this resource. These can only be added or modified by the setLabels method. Each label key/value pair must comply with RFC1035. Label values may be empty.
     */
     ...
     * Indicates the user-supplied redundancy type of this external VPN gateway.
     */
    redundancyType?: pulumi.Input<enums.compute.beta.ExternalVpnGatewayRedundancyType>;
    /**
