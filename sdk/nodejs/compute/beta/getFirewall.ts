...
export function getFirewall(args: GetFirewallArgs, opts?: pulumi.InvokeOptions): Promise<GetFirewallResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:compute/beta:getFirewall", {
...
export interface GetFirewallResult {
     ...
     */
    readonly allowed: outputs.compute.beta.FirewallAllowedItemResponse[];
    /**
     ...
     */
    readonly denied: outputs.compute.beta.FirewallDeniedItemResponse[];
    /**
