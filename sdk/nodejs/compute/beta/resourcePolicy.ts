...
export class ResourcePolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:compute/beta:ResourcePolicy';
     ...
     */
    public readonly groupPlacementPolicy!: pulumi.Output<outputs.compute.beta.ResourcePolicyGroupPlacementPolicyResponse>;
    /**
     * Resource policy for scheduling instance operations.
     */
    public readonly instanceSchedulePolicy!: pulumi.Output<outputs.compute.beta.ResourcePolicyInstanceSchedulePolicyResponse>;
    /**
     ...
     */
    public /*out*/ readonly resourceStatus!: pulumi.Output<outputs.compute.beta.ResourcePolicyResourceStatusResponse>;
    /**
     ...
     */
    public readonly snapshotSchedulePolicy!: pulumi.Output<outputs.compute.beta.ResourcePolicySnapshotSchedulePolicyResponse>;
    /**
...
export interface ResourcePolicyArgs {
     ...
     * Resource policy for instances for placement configuration.
     */
    groupPlacementPolicy?: pulumi.Input<inputs.compute.beta.ResourcePolicyGroupPlacementPolicyArgs>;
    /**
     * Resource policy for scheduling instance operations.
     */
    instanceSchedulePolicy?: pulumi.Input<inputs.compute.beta.ResourcePolicyInstanceSchedulePolicyArgs>;
    /**
     * The name of the resource, provided by the client when initially creating the resource. The resource name must be 1-63 characters long, and comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression `[a-z]([-a-z0-9]*[a-z0-9])?` which means the first character must be a lowercase letter, and all following characters must be a dash, lowercase letter, or digit, except the last character, which cannot be a dash.
     */
     ...
     * Resource policy for persistent disks for creating snapshots.
     */
    snapshotSchedulePolicy?: pulumi.Input<inputs.compute.beta.ResourcePolicySnapshotSchedulePolicyArgs>;
}
