...
/**
 * @deprecated google-hybrid.compute.MangedSslCertificate has been deprecated in favor of google-hybrid.compute.ManagedSslCertificate
 */
export class MangedSslCertificate extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: MangedSslCertificateState, opts?: pulumi.CustomResourceOptions): MangedSslCertificate {
        pulumi.log.warn("MangedSslCertificate is deprecated: google-hybrid.compute.MangedSslCertificate has been deprecated in favor of google-hybrid.compute.ManagedSslCertificate")
        return new MangedSslCertificate(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:compute/classic:MangedSslCertificate';
     ...
     * of 'MANAGED' in 'type').
     */
    public readonly managed!: pulumi.Output<outputs.compute.MangedSslCertificateManaged.MangedSslCertificateManaged | undefined>;
    /**
...
export interface MangedSslCertificateState {
     ...
     * of 'MANAGED' in 'type').
     */
    managed?: pulumi.Input<inputs.compute.MangedSslCertificateManaged.MangedSslCertificateManagedArgs>;
    /**
     * Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
     * comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
     * '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
