...
export class ManagedSslCertificate extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:compute/classic:ManagedSslCertificate';
     ...
     * of 'MANAGED' in 'type').
     */
    public readonly managed!: pulumi.Output<outputs.compute.ManagedSslCertificateManaged.ManagedSslCertificateManaged | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: ManagedSslCertificateArgs | ManagedSslCertificateState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "google-hybrid:compute/classic:MangedSslCertificate" }] };
...
export interface ManagedSslCertificateState {
     ...
     * of 'MANAGED' in 'type').
     */
    managed?: pulumi.Input<inputs.compute.ManagedSslCertificateManaged.ManagedSslCertificateManagedArgs>;
    /**
     * Name of the resource. Provided by the client when the resource is created. The name must be 1-63 characters long, and
     * comply with RFC1035. Specifically, the name must be 1-63 characters long and match the regular expression
     * '[a-z]([-a-z0-9]*[a-z0-9])?' which means the first character must be a lowercase letter, and all following characters
