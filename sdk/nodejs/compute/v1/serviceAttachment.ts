...
export class ServiceAttachment extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly connectedEndpoints!: pulumi.Output<outputs.compute.v1.ServiceAttachmentConnectedEndpointResponse[]>;
    /**
     ...
     */
    public readonly consumerAcceptLists!: pulumi.Output<outputs.compute.v1.ServiceAttachmentConsumerProjectLimitResponse[]>;
    /**
     ...
     */
    public /*out*/ readonly pscServiceAttachmentId!: pulumi.Output<outputs.compute.v1.Uint128Response>;
    /**
...
export interface ServiceAttachmentArgs {
     ...
     * The connection preference of service attachment. The value can be set to ACCEPT_AUTOMATIC. An ACCEPT_AUTOMATIC service attachment is one that always accepts the connection from consumer forwarding rules.
     */
    connectionPreference?: pulumi.Input<enums.compute.v1.ServiceAttachmentConnectionPreference>;
    /**
     * Projects that are allowed to connect to this service attachment.
     */
    consumerAcceptLists?: pulumi.Input<pulumi.Input<inputs.compute.v1.ServiceAttachmentConsumerProjectLimitArgs>[]>;
    /**
     * Projects that are not allowed to connect to this service attachment. The project can be specified using its id or number.
     */
