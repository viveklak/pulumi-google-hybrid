...
export function getNodeTemplate(args: GetNodeTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeTemplateResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:compute/alpha:getNodeTemplate", {
...
export interface GetNodeTemplateResult {
    readonly accelerators: outputs.compute.alpha.AcceleratorConfigResponse[];
    /**
     * CPU overcommit.
     */
     ...
     */
    readonly nodeTypeFlexibility: outputs.compute.alpha.NodeTemplateNodeTypeFlexibilityResponse;
    /**
     ...
     */
    readonly serverBinding: outputs.compute.alpha.ServerBindingResponse;
    /**
