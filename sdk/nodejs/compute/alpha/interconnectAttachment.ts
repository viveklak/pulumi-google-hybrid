...
export class InterconnectAttachment extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:compute/alpha:InterconnectAttachment';
     ...
     */
    public readonly partnerMetadata!: pulumi.Output<outputs.compute.alpha.InterconnectAttachmentPartnerMetadataResponse>;
    /**
...
export interface InterconnectAttachmentArgs {
     ...
     * Informational metadata about Partner attachments from Partners to display to customers. Output only for for PARTNER type, mutable for PARTNER_PROVIDER, not available for DEDICATED.
     */
    partnerMetadata?: pulumi.Input<inputs.compute.alpha.InterconnectAttachmentPartnerMetadataArgs>;
