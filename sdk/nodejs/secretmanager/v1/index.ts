...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:secretmanager/v1:Secret":
                return new Secret(name, <any>undefined, { urn })
            case "google-hybrid:secretmanager/v1:SecretIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "secretmanager/v1", _module)
