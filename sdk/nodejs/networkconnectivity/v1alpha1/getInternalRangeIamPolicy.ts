 ...
 */
export function getInternalRangeIamPolicy(args: GetInternalRangeIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetInternalRangeIamPolicyResult> {
    if (!opts) {
        opts = {}
    }
...
export interface GetInternalRangeIamPolicyArgs {
