...
export class AzureCluster extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:container/classic:AzureCluster';
     ...
     */
    public readonly authorization!: pulumi.Output<outputs.container.AzureClusterAuthorization.AzureClusterAuthorization>;
    /**
     * Required. The Azure region where the cluster runs. Each Google Cloud region supports a subset of nearby Azure regions.
     * You can call to list all supported Azure regions within a given Google Cloud region.
     */
    public readonly azureRegion!: pulumi.Output<string>;
    /**
     * Required. Name of the AzureClient. The `AzureClient` resource must reside on the same GCP project and region as the
     ...
     */
    public readonly controlPlane!: pulumi.Output<outputs.container.AzureClusterControlPlane.AzureClusterControlPlane>;
    /**
     ...
     * Fleet configuration.
     */
    public readonly fleet!: pulumi.Output<outputs.container.AzureClusterFleet.AzureClusterFleet>;
    /**
     ...
     */
    public readonly networking!: pulumi.Output<outputs.container.AzureClusterNetworking.AzureClusterNetworking>;
    /**
     ...
     */
    public /*out*/ readonly workloadIdentityConfigs!: pulumi.Output<outputs.container.AzureClusterWorkloadIdentityConfig.AzureClusterWorkloadIdentityConfig[]>;
...
export interface AzureClusterState {
     ...
     * Required. Configuration related to the cluster RBAC settings.
     */
    authorization?: pulumi.Input<inputs.container.AzureClusterAuthorization.AzureClusterAuthorizationArgs>;
    /**
     * Required. The Azure region where the cluster runs. Each Google Cloud region supports a subset of nearby Azure regions.
     * You can call to list all supported Azure regions within a given Google Cloud region.
     */
     ...
     * Required. Configuration related to the cluster control plane.
     */
    controlPlane?: pulumi.Input<inputs.container.AzureClusterControlPlane.AzureClusterControlPlaneArgs>;
    /**
     * Output only. The time at which this cluster was created.
     */
     ...
     * Fleet configuration.
     */
    fleet?: pulumi.Input<inputs.container.AzureClusterFleet.AzureClusterFleetArgs>;
    /**
     * The location for the resource
     */
     ...
     * Required. Cluster-wide networking configuration.
     */
    networking?: pulumi.Input<inputs.container.AzureClusterNetworking.AzureClusterNetworkingArgs>;
    /**
     * The project for the resource
     */
     ...
     * Output only. Workload Identity settings.
     */
    workloadIdentityConfigs?: pulumi.Input<pulumi.Input<inputs.container.AzureClusterWorkloadIdentityConfig.AzureClusterWorkloadIdentityConfigArgs>[]>;
}
