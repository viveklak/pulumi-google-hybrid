...
export class NodePool extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:container/classic:NodePool';
     ...
     */
    public readonly autoscaling!: pulumi.Output<outputs.container.NodePoolAutoscaling.NodePoolAutoscaling | undefined>;
    /**
     ...
     */
    public readonly management!: pulumi.Output<outputs.container.NodePoolManagement.NodePoolManagement>;
    /**
     ...
     */
    public readonly networkConfig!: pulumi.Output<outputs.container.NodePoolNetworkConfig.NodePoolNetworkConfig>;
    /**
     * The configuration of the nodepool
     */
    public readonly nodeConfig!: pulumi.Output<outputs.container.NodePoolNodeConfig.NodePoolNodeConfig>;
    /**
     ...
     */
    public readonly placementPolicy!: pulumi.Output<outputs.container.NodePoolPlacementPolicy.NodePoolPlacementPolicy | undefined>;
    /**
     ...
     * limited to 20.
     */
    public readonly upgradeSettings!: pulumi.Output<outputs.container.NodePoolUpgradeSettings.NodePoolUpgradeSettings>;
    /**
...
export interface NodePoolState {
     ...
     * Configuration required by cluster autoscaler to adjust the size of the node pool to the current cluster usage.
     */
    autoscaling?: pulumi.Input<inputs.container.NodePoolAutoscaling.NodePoolAutoscalingArgs>;
    /**
     * The cluster to create the node pool for. Cluster must be present in location provided for zonal clusters.
     */
     ...
     * Node management configuration, wherein auto-repair and auto-upgrade is configured.
     */
    management?: pulumi.Input<inputs.container.NodePoolManagement.NodePoolManagementArgs>;
    /**
     * The maximum number of pods per node in this node pool. Note that this does not work on node pools which are
     * "route-based" - that is, node pools belonging to clusters that do not have IP Aliasing enabled.
     */
     ...
     * Networking configuration for this NodePool. If specified, it overrides the cluster-level defaults.
     */
    networkConfig?: pulumi.Input<inputs.container.NodePoolNetworkConfig.NodePoolNetworkConfigArgs>;
    /**
     * The configuration of the nodepool
     */
    nodeConfig?: pulumi.Input<inputs.container.NodePoolNodeConfig.NodePoolNodeConfigArgs>;
    /**
     * The number of nodes per instance group. This field can be used to update the number of nodes per instance group but
     * should not be used alongside autoscaling.
     */
     ...
     * Specifies the node placement policy
     */
    placementPolicy?: pulumi.Input<inputs.container.NodePoolPlacementPolicy.NodePoolPlacementPolicyArgs>;
    /**
     * The ID of the project in which to create the node pool. If blank, the provider-configured project will be used.
     */
     ...
     * limited to 20.
     */
    upgradeSettings?: pulumi.Input<inputs.container.NodePoolUpgradeSettings.NodePoolUpgradeSettingsArgs>;
    /**
     * The Kubernetes version for the nodes in this pool. Note that if this field and auto_upgrade are both specified, they
     * will fight each other for what the node version should be, so setting both is highly discouraged. While a fuzzy version
     * can be specified, it's recommended that you specify explicit versions as Terraform will see spurious diffs when fuzzy
