...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:clouddeploy/v1:DeliveryPipeline":
                return new DeliveryPipeline(name, <any>undefined, { urn })
            case "google-hybrid:clouddeploy/v1:DeliveryPipelineIamPolicy":
                return new DeliveryPipelineIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:clouddeploy/v1:Release":
                return new Release(name, <any>undefined, { urn })
            case "google-hybrid:clouddeploy/v1:Rollout":
                return new Rollout(name, <any>undefined, { urn })
            case "google-hybrid:clouddeploy/v1:Target":
                return new Target(name, <any>undefined, { urn })
            case "google-hybrid:clouddeploy/v1:TargetIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "clouddeploy/v1", _module)
