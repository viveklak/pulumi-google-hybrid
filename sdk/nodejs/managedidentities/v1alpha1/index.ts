...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:managedidentities/v1alpha1:Backup":
                return new Backup(name, <any>undefined, { urn })
            case "google-hybrid:managedidentities/v1alpha1:Domain":
                return new Domain(name, <any>undefined, { urn })
            case "google-hybrid:managedidentities/v1alpha1:DomainBackupIamPolicy":
                return new DomainBackupIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:managedidentities/v1alpha1:DomainIamPolicy":
                return new DomainIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:managedidentities/v1alpha1:Peering":
                return new Peering(name, <any>undefined, { urn })
            case "google-hybrid:managedidentities/v1alpha1:PeeringIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "managedidentities/v1alpha1", _module)
