...
export class DatacenterConnector extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:vmmigration/v1alpha1:DatacenterConnector';
     ...
     */
    public /*out*/ readonly upgradeStatus!: pulumi.Output<outputs.vmmigration.v1alpha1.UpgradeStatusResponse>;
    /**
