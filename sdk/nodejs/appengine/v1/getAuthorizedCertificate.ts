...
export function getAuthorizedCertificate(args: GetAuthorizedCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizedCertificateResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:appengine/v1:getAuthorizedCertificate", {
        "appId": args.appId,
...
export interface GetAuthorizedCertificateResult {
     ...
     */
    readonly certificateRawData: outputs.appengine.v1.CertificateRawDataResponse;
    /**
     ...
     */
    readonly managedCertificate: outputs.appengine.v1.ManagedCertificateResponse;
    /**
