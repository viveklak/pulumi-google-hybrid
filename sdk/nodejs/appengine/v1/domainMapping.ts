...
export class DomainMapping extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:appengine/v1:DomainMapping';
     ...
     */
    public /*out*/ readonly resourceRecords!: pulumi.Output<outputs.appengine.v1.ResourceRecordResponse[]>;
    /**
...
export interface DomainMappingArgs {
     ...
     * SSL configuration for this domain. If unconfigured, this domain will not serve with SSL.
     */
    sslSettings?: pulumi.Input<inputs.appengine.v1.SslSettingsArgs>;
}
