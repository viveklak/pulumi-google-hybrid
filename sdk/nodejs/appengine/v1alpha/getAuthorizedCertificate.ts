...
export function getAuthorizedCertificate(args: GetAuthorizedCertificateArgs, opts?: pulumi.InvokeOptions): Promise<GetAuthorizedCertificateResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:appengine/v1alpha:getAuthorizedCertificate", {
        "appId": args.appId,
...
export interface GetAuthorizedCertificateResult {
     ...
     */
    readonly certificateRawData: outputs.appengine.v1alpha.CertificateRawDataResponse;
    /**
     ...
     */
    readonly managedCertificate: outputs.appengine.v1alpha.ManagedCertificateResponse;
    /**
