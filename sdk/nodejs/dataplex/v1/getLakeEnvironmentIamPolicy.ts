...
export function getLakeEnvironmentIamPolicy(args: GetLakeEnvironmentIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetLakeEnvironmentIamPolicyResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:dataplex/v1:getLakeEnvironmentIamPolicy", {
...
export interface GetLakeEnvironmentIamPolicyArgs {
...
export interface GetLakeEnvironmentIamPolicyResult {
    /**
