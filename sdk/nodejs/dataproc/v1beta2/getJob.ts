...
export function getJob(args: GetJobArgs, opts?: pulumi.InvokeOptions): Promise<GetJobResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:dataproc/v1beta2:getJob", {
        "jobId": args.jobId,
...
export interface GetJobResult {
     ...
     */
    readonly hadoopJob: outputs.dataproc.v1beta2.HadoopJobResponse;
    /**
     * Optional. Job is a Hive job.
     */
    readonly hiveJob: outputs.dataproc.v1beta2.HiveJobResponse;
    /**
     ...
     */
    readonly pigJob: outputs.dataproc.v1beta2.PigJobResponse;
    /**
     * Job information, including how, when, and where to run the job.
     */
    readonly placement: outputs.dataproc.v1beta2.JobPlacementResponse;
    /**
     * Optional. Job is a Presto job.
     */
    readonly prestoJob: outputs.dataproc.v1beta2.PrestoJobResponse;
    /**
     * Optional. Job is a PySpark job.
     */
    readonly pysparkJob: outputs.dataproc.v1beta2.PySparkJobResponse;
    /**
     * Optional. The fully qualified reference to the job, which can be used to obtain the equivalent REST path of the job resource. If this property is not specified when a job is created, the server generates a job_id.
     */
    readonly reference: outputs.dataproc.v1beta2.JobReferenceResponse;
    /**
     * Optional. Job scheduling configuration.
     */
    readonly scheduling: outputs.dataproc.v1beta2.JobSchedulingResponse;
    /**
     * Optional. Job is a Spark job.
     */
    readonly sparkJob: outputs.dataproc.v1beta2.SparkJobResponse;
    /**
     * Optional. Job is a SparkR job.
     */
    readonly sparkRJob: outputs.dataproc.v1beta2.SparkRJobResponse;
    /**
     * Optional. Job is a SparkSql job.
     */
    readonly sparkSqlJob: outputs.dataproc.v1beta2.SparkSqlJobResponse;
    /**
     ...
     */
    readonly status: outputs.dataproc.v1beta2.JobStatusResponse;
    /**
     * The previous job status.
     */
    readonly statusHistory: outputs.dataproc.v1beta2.JobStatusResponse[];
    /**
