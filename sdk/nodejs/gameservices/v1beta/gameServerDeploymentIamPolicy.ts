...
export class GameServerDeploymentIamPolicy extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:gameservices/v1beta:GameServerDeploymentIamPolicy';
     ...
     */
    public readonly rules!: pulumi.Output<outputs.gameservices.v1beta.RuleResponse[]>;
    /**
...
export interface GameServerDeploymentIamPolicyArgs {
     ...
     * If more than one rule is specified, the rules are applied in the following manner: - All matching LOG rules are always applied. - If any DENY/DENY_WITH_LOG rule matches, permission is denied. Logging will be applied if one or more matching rule requires logging. - Otherwise, if any ALLOW/ALLOW_WITH_LOG rule matches, permission is granted. Logging will be applied if one or more matching rule requires logging. - Otherwise, if no rule applies, permission is denied.
     */
    rules?: pulumi.Input<pulumi.Input<inputs.gameservices.v1beta.RuleArgs>[]>;
    /**
