...
export function getEndpointPolicy(args: GetEndpointPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetEndpointPolicyResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:networkservices/v1:getEndpointPolicy", {
...
export interface GetEndpointPolicyResult {
     ...
     */
    readonly endpointMatcher: outputs.networkservices.v1.EndpointMatcherResponse;
    /**
     ...
     */
    readonly trafficPortSelector: outputs.networkservices.v1.TrafficPortSelectorResponse;
    /**
