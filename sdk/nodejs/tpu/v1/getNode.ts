...
export function getNode(args: GetNodeArgs, opts?: pulumi.InvokeOptions): Promise<GetNodeResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:tpu/v1:getNode", {
...
export interface GetNodeResult {
     ...
     */
    readonly schedulingConfig: outputs.tpu.v1.SchedulingConfigResponse;
    /**
     ...
     */
    readonly symptoms: outputs.tpu.v1.SymptomResponse[];
    /**
