...
/**
 * @deprecated google-hybrid.kms.Registry has been deprecated in favor of google-hybrid.iot.Registry
 */
export class Registry extends pulumi.CustomResource {
    ...
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: RegistryState, opts?: pulumi.CustomResourceOptions): Registry {
        pulumi.log.warn("Registry is deprecated: google-hybrid.kms.Registry has been deprecated in favor of google-hybrid.iot.Registry")
        return new Registry(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:kms/classic:Registry';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.kms.RegistryCredential.RegistryCredential[] | undefined>;
    /**
     * List of configurations for event notifications, such as PubSub topics to publish device events to.
     */
    public readonly eventNotificationConfigs!: pulumi.Output<outputs.kms.RegistryEventNotificationConfigItem.RegistryEventNotificationConfigItem[]>;
    /**
...
export interface RegistryState {
     ...
     * List of public key certificates to authenticate devices.
     */
    credentials?: pulumi.Input<pulumi.Input<inputs.kms.RegistryCredential.RegistryCredentialArgs>[]>;
    /**
     * List of configurations for event notifications, such as PubSub topics to publish device events to.
     */
    eventNotificationConfigs?: pulumi.Input<pulumi.Input<inputs.kms.RegistryEventNotificationConfigItem.RegistryEventNotificationConfigItemArgs>[]>;
    /**
     * Activate or deactivate HTTP.
     */
