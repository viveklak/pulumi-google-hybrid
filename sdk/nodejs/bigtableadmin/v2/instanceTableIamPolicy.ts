 ...
 */
export class InstanceTableIamPolicy extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, opts?: pulumi.CustomResourceOptions): InstanceTableIamPolicy {
        return new InstanceTableIamPolicy(name, undefined as any, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:bigtableadmin/v2:InstanceTableIamPolicy';

    /**
     * Returns true if the given object is an instance of InstanceTableIamPolicy.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is InstanceTableIamPolicy {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === InstanceTableIamPolicy.__pulumiType;
    }
     ...
     */
    constructor(name: string, args: InstanceTableIamPolicyArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        super(InstanceTableIamPolicy.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface InstanceTableIamPolicyArgs {
    /**
     * Specifies cloud audit logging configuration for this policy.
     */
