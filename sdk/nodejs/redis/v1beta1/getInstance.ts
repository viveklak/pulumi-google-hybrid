...
export function getInstance(args: GetInstanceArgs, opts?: pulumi.InvokeOptions): Promise<GetInstanceResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:redis/v1beta1:getInstance", {
...
export interface GetInstanceResult {
     ...
     */
    readonly maintenancePolicy: outputs.redis.v1beta1.MaintenancePolicyResponse;
    /**
     * Date and time of upcoming maintenance events which have been scheduled.
     */
    readonly maintenanceSchedule: outputs.redis.v1beta1.MaintenanceScheduleResponse;
    /**
     ...
     * Info per node.
     */
    readonly nodes: outputs.redis.v1beta1.NodeInfoResponse[];
    /**
     * Optional. Persistence configuration parameters
     */
    readonly persistenceConfig: outputs.redis.v1beta1.PersistenceConfigResponse;
    /**
     ...
     */
    readonly serverCaCerts: outputs.redis.v1beta1.TlsCertificateResponse[];
    /**
