...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:datafusion/v1:Instance":
                return new Instance(name, <any>undefined, { urn })
            case "google-hybrid:datafusion/v1:InstanceIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "datafusion/v1", _module)
