...
export class Registry extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:iot/classic:Registry';
     ...
     */
    public readonly credentials!: pulumi.Output<outputs.iot.RegistryCredential.RegistryCredential[] | undefined>;
    /**
     * List of configurations for event notifications, such as PubSub topics to publish device events to.
     */
    public readonly eventNotificationConfigs!: pulumi.Output<outputs.iot.RegistryEventNotificationConfigItem.RegistryEventNotificationConfigItem[]>;
    /**
    ...
    constructor(name: string, argsOrState?: RegistryArgs | RegistryState, opts?: pulumi.CustomResourceOptions) {
        ...
        const aliasOpts = { aliases: [{ type: "google-hybrid:kms/classic:Registry" }] };
...
export interface RegistryState {
     ...
     * List of public key certificates to authenticate devices.
     */
    credentials?: pulumi.Input<pulumi.Input<inputs.iot.RegistryCredential.RegistryCredentialArgs>[]>;
    /**
     * List of configurations for event notifications, such as PubSub topics to publish device events to.
     */
    eventNotificationConfigs?: pulumi.Input<pulumi.Input<inputs.iot.RegistryEventNotificationConfigItem.RegistryEventNotificationConfigItemArgs>[]>;
    /**
     * Activate or deactivate HTTP.
     */
