...
export class ManagedZone extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:dns/v2:ManagedZone';
    ...
    public readonly cloudLoggingConfig!: pulumi.Output<outputs.dns.v2.ManagedZoneCloudLoggingConfigResponse>;
    /**
     ...
     */
    public readonly dnssecConfig!: pulumi.Output<outputs.dns.v2.ManagedZoneDnsSecConfigResponse>;
    /**
     * The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field contains the set of destinations to forward to.
     */
    public readonly forwardingConfig!: pulumi.Output<outputs.dns.v2.ManagedZoneForwardingConfigResponse>;
     ...
     */
    public readonly peeringConfig!: pulumi.Output<outputs.dns.v2.ManagedZonePeeringConfigResponse>;
    /**
     * For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
     */
    public readonly privateVisibilityConfig!: pulumi.Output<outputs.dns.v2.ManagedZonePrivateVisibilityConfigResponse>;
    /**
     * The presence of this field indicates that this is a managed reverse lookup zone and Cloud DNS resolves reverse lookup queries using automatically configured records for VPC resources. This only applies to networks listed under private_visibility_config.
     */
    public readonly reverseLookupConfig!: pulumi.Output<outputs.dns.v2.ManagedZoneReverseLookupConfigResponse>;
    /**
     * This field links to the associated service directory namespace. Do not set this field for public zones or forwarding zones.
     */
    public readonly serviceDirectoryConfig!: pulumi.Output<outputs.dns.v2.ManagedZoneServiceDirectoryConfigResponse>;
    /**
...
export interface ManagedZoneArgs {
    ...
    cloudLoggingConfig?: pulumi.Input<inputs.dns.v2.ManagedZoneCloudLoggingConfigArgs>;
    /**
     * The time that this resource was created on the server. This is in RFC3339 text format. Output only.
     */
     ...
     * DNSSEC configuration.
     */
    dnssecConfig?: pulumi.Input<inputs.dns.v2.ManagedZoneDnsSecConfigArgs>;
    /**
     * The presence for this field indicates that outbound forwarding is enabled for this zone. The value of this field contains the set of destinations to forward to.
     */
    forwardingConfig?: pulumi.Input<inputs.dns.v2.ManagedZoneForwardingConfigArgs>;
    /**
     ...
     * The presence of this field indicates that DNS Peering is enabled for this zone. The value of this field contains the network to peer with.
     */
    peeringConfig?: pulumi.Input<inputs.dns.v2.ManagedZonePeeringConfigArgs>;
    /**
     * For privately visible zones, the set of Virtual Private Cloud resources that the zone is visible from.
     */
    privateVisibilityConfig?: pulumi.Input<inputs.dns.v2.ManagedZonePrivateVisibilityConfigArgs>;
    project?: pulumi.Input<string>;
    /**
     * The presence of this field indicates that this is a managed reverse lookup zone and Cloud DNS resolves reverse lookup queries using automatically configured records for VPC resources. This only applies to networks listed under private_visibility_config.
     */
    reverseLookupConfig?: pulumi.Input<inputs.dns.v2.ManagedZoneReverseLookupConfigArgs>;
    /**
     * This field links to the associated service directory namespace. Do not set this field for public zones or forwarding zones.
     */
    serviceDirectoryConfig?: pulumi.Input<inputs.dns.v2.ManagedZoneServiceDirectoryConfigArgs>;
    /**
     * The zone's visibility: public zones are exposed to the Internet, while private zones are visible only to Virtual Private Cloud resources.
     */
    visibility?: pulumi.Input<enums.dns.v2.ManagedZoneVisibility>;
}
