...
export function getChange(args: GetChangeArgs, opts?: pulumi.InvokeOptions): Promise<GetChangeResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:dns/v2:getChange", {
...
export interface GetChangeResult {
     ...
     */
    readonly additions: outputs.dns.v2.ResourceRecordSetResponse[];
    /**
     * Which ResourceRecordSets to remove? Must match existing data exactly.
     */
    readonly deletions: outputs.dns.v2.ResourceRecordSetResponse[];
    /**
