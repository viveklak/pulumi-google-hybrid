...
export function getDatasetConsentStoreIamPolicy(args: GetDatasetConsentStoreIamPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDatasetConsentStoreIamPolicyResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:healthcare/v1beta1:getDatasetConsentStoreIamPolicy", {
...
export interface GetDatasetConsentStoreIamPolicyArgs {
...
export interface GetDatasetConsentStoreIamPolicyResult {
    /**
