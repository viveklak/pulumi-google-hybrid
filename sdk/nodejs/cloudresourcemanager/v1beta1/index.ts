...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:cloudresourcemanager/v1beta1:OrganizationIamPolicy":
                return new OrganizationIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:cloudresourcemanager/v1beta1:Project":
                return new Project(name, <any>undefined, { urn })
            case "google-hybrid:cloudresourcemanager/v1beta1:ProjectIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "cloudresourcemanager/v1beta1", _module)
