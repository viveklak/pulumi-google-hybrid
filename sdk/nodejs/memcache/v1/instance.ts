...
export class Instance extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:memcache/v1:Instance';
     ...
     */
    public readonly maintenancePolicy!: pulumi.Output<outputs.memcache.v1.GoogleCloudMemcacheV1MaintenancePolicyResponse>;
    /**
     * Published maintenance schedule.
     */
    public /*out*/ readonly maintenanceSchedule!: pulumi.Output<outputs.memcache.v1.MaintenanceScheduleResponse>;
    /**
...
export interface InstanceArgs {
     ...
     * The maintenance policy for the instance. If not provided, the maintenance event will be performed based on Memorystore internal rollout schedule.
     */
    maintenancePolicy?: pulumi.Input<inputs.memcache.v1.GoogleCloudMemcacheV1MaintenancePolicyArgs>;
    /**
     * The major version of Memcached software. If not provided, latest supported version will be used. Currently the latest supported major version is `MEMCACHE_1_5`. The minor version will be automatically determined by our system based on the latest supported minor version.
     */
