...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:pubsub/v1:Schema":
                return new Schema(name, <any>undefined, { urn })
            case "google-hybrid:pubsub/v1:SchemaIamPolicy":
                return new SchemaIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:pubsub/v1:Snapshot":
                return new Snapshot(name, <any>undefined, { urn })
            case "google-hybrid:pubsub/v1:SnapshotIamPolicy":
                return new SnapshotIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:pubsub/v1:Subscription":
                return new Subscription(name, <any>undefined, { urn })
            case "google-hybrid:pubsub/v1:SubscriptionIamPolicy":
                return new SubscriptionIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:pubsub/v1:Topic":
                return new Topic(name, <any>undefined, { urn })
            case "google-hybrid:pubsub/v1:TopicIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "pubsub/v1", _module)
