...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:cloudtasks/v2beta2:Queue":
                return new Queue(name, <any>undefined, { urn })
            case "google-hybrid:cloudtasks/v2beta2:QueueIamPolicy":
                return new QueueIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:cloudtasks/v2beta2:Task":
...
pulumi.runtime.registerResourceModule("google-hybrid", "cloudtasks/v2beta2", _module)
