...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:securitycenter/v1:FolderBigQueryExport":
                return new FolderBigQueryExport(name, <any>undefined, { urn })
            case "google-hybrid:securitycenter/v1:MuteConfig":
                return new MuteConfig(name, <any>undefined, { urn })
            case "google-hybrid:securitycenter/v1:NotificationConfig":
                return new NotificationConfig(name, <any>undefined, { urn })
            case "google-hybrid:securitycenter/v1:OrganizationBigQueryExport":
                return new OrganizationBigQueryExport(name, <any>undefined, { urn })
            case "google-hybrid:securitycenter/v1:OrganizationMuteConfig":
                return new OrganizationMuteConfig(name, <any>undefined, { urn })
            case "google-hybrid:securitycenter/v1:OrganizationSourceIamPolicy":
                return new OrganizationSourceIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:securitycenter/v1:ProjectBigQueryExport":
                return new ProjectBigQueryExport(name, <any>undefined, { urn })
            case "google-hybrid:securitycenter/v1:Source":
...
pulumi.runtime.registerResourceModule("google-hybrid", "securitycenter/v1", _module)
