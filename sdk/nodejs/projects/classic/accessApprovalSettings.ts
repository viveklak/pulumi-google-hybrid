...
export class AccessApprovalSettings extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:projects/classic:AccessApprovalSettings';
     ...
     */
    public readonly enrolledServices!: pulumi.Output<outputs.projects.AccessApprovalSettingsEnrolledService.AccessApprovalSettingsEnrolledService[]>;
    /**
...
export interface AccessApprovalSettingsState {
     ...
     * expanded as the set of supported services is expanded.
     */
    enrolledServices?: pulumi.Input<pulumi.Input<inputs.projects.AccessApprovalSettingsEnrolledService.AccessApprovalSettingsEnrolledServiceArgs>[]>;
    /**
     * The resource name of the settings. Format is "projects/{project_id}/accessApprovalSettings"
     */
