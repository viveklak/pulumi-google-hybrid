...
export class IAMBinding extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:projects/classic:IAMBinding';
    ...
    public readonly condition!: pulumi.Output<outputs.projects.IAMBindingCondition.IAMBindingCondition | undefined>;
...
export interface IAMBindingState {
    condition?: pulumi.Input<inputs.projects.IAMBindingCondition.IAMBindingConditionArgs>;
