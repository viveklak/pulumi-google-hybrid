...
export function getDeployment(args: GetDeploymentArgs, opts?: pulumi.InvokeOptions): Promise<GetDeploymentResult> {
    ...
    return pulumi.runtime.invoke("google-hybrid:deploymentmanager/v2beta:getDeployment", {
...
export interface GetDeploymentResult {
     ...
     */
    readonly labels: outputs.deploymentmanager.v2beta.DeploymentLabelEntryResponse[];
    /**
     ...
     */
    readonly target: outputs.deploymentmanager.v2beta.TargetConfigurationResponse;
    /**
     ...
     */
    readonly update: outputs.deploymentmanager.v2beta.DeploymentUpdateResponse;
    /**
