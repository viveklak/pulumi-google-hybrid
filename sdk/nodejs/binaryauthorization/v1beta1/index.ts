...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:binaryauthorization/v1beta1:Attestor":
                return new Attestor(name, <any>undefined, { urn })
            case "google-hybrid:binaryauthorization/v1beta1:AttestorIamPolicy":
                return new AttestorIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:binaryauthorization/v1beta1:PolicyIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "binaryauthorization/v1beta1", _module)
