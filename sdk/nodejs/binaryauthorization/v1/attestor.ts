...
export class Attestor extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'google-hybrid:binaryauthorization/v1:Attestor';
    ...
    constructor(name: string, args: AttestorArgs, opts?: pulumi.CustomResourceOptions) {
        ...
        if (!opts.id) {
            ...
            resourceInputs["userOwnedGrafeasNote"] = args ? args.userOwnedGrafeasNote : undefined;
...
export interface AttestorArgs {
     ...
     * This specifies how an attestation will be read, and how it will be used during policy enforcement.
     */
    userOwnedGrafeasNote?: pulumi.Input<inputs.binaryauthorization.v1.UserOwnedGrafeasNoteArgs>;
}
