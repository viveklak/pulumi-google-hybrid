...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:binaryauthorization/v1:Attestor":
                return new Attestor(name, <any>undefined, { urn })
            case "google-hybrid:binaryauthorization/v1:AttestorIamPolicy":
                return new AttestorIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:binaryauthorization/v1:PolicyIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "binaryauthorization/v1", _module)
