...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            case "google-hybrid:datamigration/v1beta1:ConnectionProfile":
                return new ConnectionProfile(name, <any>undefined, { urn })
            case "google-hybrid:datamigration/v1beta1:ConnectionProfileIamPolicy":
                return new ConnectionProfileIamPolicy(name, <any>undefined, { urn })
            case "google-hybrid:datamigration/v1beta1:MigrationJob":
                return new MigrationJob(name, <any>undefined, { urn })
            case "google-hybrid:datamigration/v1beta1:MigrationJobIamPolicy":
...
pulumi.runtime.registerResourceModule("google-hybrid", "datamigration/v1beta1", _module)
