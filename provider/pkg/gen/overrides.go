...
var autonameOverrides = map[string]string{
	"google-hybrid:cloudkms/v1:CryptoKey":        "cryptoKeyId",
	"google-hybrid:cloudkms/v1:CryptoKeyVersion": "cryptoKeyId",
	"google-hybrid:cloudkms/v1:EkmConnection":    "ekmConnectionId",
	"google-hybrid:cloudkms/v1:ImportJob":        "importJobId",
	"google-hybrid:cloudkms/v1:KeyRing":          "keyRingId",
}
